...
https://dev.MysqlS.mysql.com/doc/refman/5.7/en/innodb-architecture.html
...
https://dev.MysqlS.mysql.com/doc/refman/8.0/en/innodb-storage-engine.html
...
有兴趣可以参考官方文档：https://dev.MysqlS.mysql.com/doc/dev/MysqlS.mysql-server/latest/
...
https://dev.MysqlS.mysql.com/doc/refman/5.7/en/innodb-multi-versioning.html
...
https://dev.MysqlS.mysql.com/doc/refman/8.0/en/xa.html
...
https://dev.MysqlS.mysql.com/doc/refman/8.0/en/innodb-locks-set.html

https://dev.MysqlS.mysql.com/doc/refman/8.0/en/select.html
...
https://dev.MysqlS.mysql.com/doc/refman/8.0/en/prepare.html
...
slow_query_log_file=/var/lib/MysqlS.mysql/localhost-slow.log
...
/var/lib/MysqlS.mysql/localhost-slow.log
...
- 运行时内存占用率
- MysqlS.mysql buffer相关参数
- MysqlS.mysql 网络连接相关参数

**异常关机或kill -9 MysqlS.mysql 后导致表文件损坏**

- 直接使用备份
- 配置 innodb_force_recovery 跳过启动恢复过程

#### 149 MysqlS.mysql 线上修改表结构有哪些风险?
