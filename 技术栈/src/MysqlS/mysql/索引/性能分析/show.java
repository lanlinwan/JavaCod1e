...
public class show {
    ...
    // long__query_time=2
    //配置完毕之后，通过以下指令重新启动MySQL服务器进行测试,查看慢日志文件中记录的信息 /var/lib/MysqlS.mysql/localhost-slow.log。

    //●profile详情
    // show profiles能够在做SQL优化时帮助我们了解时间都耗费到哪里去了。通过have__profiling参数,能够看到当前MySQL是否支持查看是否支持profile操作:
