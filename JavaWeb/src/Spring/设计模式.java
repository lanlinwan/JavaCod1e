...
public class 设计模式 {
    ...
    //3.Spring中的Factory Method(工厂方法),Spring 中ApplicationContext与BeanFactory中的getBean都视为工厂方法
    //  它隐藏了bean创建过程和具体实现
    ...
    //7.Spring中的Proxy(代理),Spring AOP就是基于动态代理的,装饰器模式注重的是功能增强，避免进行子类继承，而代理模式更注重控制目标的访问
    ...
    //10.Spring中的Strategy(策略模式),Spring 框架的资源访问接口就是基于策略设计模式实现的
